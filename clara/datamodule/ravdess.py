...
_EMOTION_DICT = {"neutral": 0,"calm": 1,"happy": 2,"sad": 3,"angry": 4, "fearful": 5, "disgust": 6, "surprised": 7}
_GENDER_DICT = {"man": 0,"woman": 1}
_EMOTION_INTESNSITY_DICT = {"normal": 0,"strong": 1}

class RavdessTDM(BaseTDM):
	def __init__(self,
			root_data_path:str,
	...
	def to_keys(self, data):
		...
		new_labels['gender'] = _GENDER_DICT.get(labels['original_data']['actor'])
		new_labels['emotion_intensity'] = _EMOTION_INTESNSITY_DICT.get(labels['original_data']['emotional_intensity'])
